...
module.exports = async ({
  ...
  try {
    ...
    if (!awsApi) {
      ...
      const localSwaggerExt = apiMerger.mergeExtensions(localSwagger, apiName, targetPath, mediaTypes, additionalHeaders);
      ...
      const mergedSwaggerExt = apiMerger.mergeExtensions(mergedSwagger, apiName, targetPath, mediaTypes, additionalHeaders);
